            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        ...
                        <?php
                            ...
                            <?php } else { ?>
                                <li><a href="../<?php echo $mydata["href"]?>.php"><?php echo $mydata["text"]?></a></li>
                            <?php }?>
                        <?php }?>
                        </ul>
                    </nav>
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="checkout.php"><i class="fa fa-shopping-bag"></i> <span><?php echo count($_SESSION["shopping_cart"]) ?></span></a></li>
                        </ul>
